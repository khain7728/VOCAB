/**
 * layout_admin.js
 * - Tải menu_admin.html và header_admin.html vào trang template.html (của admin)
...
(function() {
    ...
    function injectLayoutStyles() {
      ...
      body.layout-admin{
        ...
        background-color: #f4f7f6; /* Màu nền chung cho admin */
      }
      
      /* Menu admin: fixed bên trái */
      body.layout-admin > #menu_admin{
        ...
        height: 100vh;
        z-index: 100;
        /* Các style cho menu_admin.css sẽ định nghĩa chi tiết */
      }
      
      /* Main container: chứa header + content, chiếm phần còn lại bên phải menu */
      body.layout-admin #main_container{
        flex: 1;
        display: flex;
        flex-direction: column;
        margin-left: 4.5rem; /* chiều rộng menu khi collapsed (giả định) */
        min-height: 100vh;
        transition: margin-left 220ms ease;
      }
      
      /* Header admin: nằm ngang phía trên */
      body.layout-admin #main_container > #header_admin{
        position: sticky;
        top: 0;
        z-index: 50;
        width: 100%;
        /* Các style cho header_admin.css sẽ định nghĩa chi tiết */
      }
      
      /* Content: chiếm phần còn lại */
      body.layout-admin #main_container > #content{
        flex: 1;
        padding: 1.5rem;
      ...
      body.layout-admin.menu-open #main_container{
        margin-left: 15rem !important; /* dịch content sang phải */
      }
      
      /* Apply các style của hover state cho menu khi menu-open (Giả định cấu trúc menu admin tương tự) */
      body.layout-admin.menu-open #menu_admin #logo{
        justify-content: flex-start !important;
        padding-left: 1rem !important;
      }
      
      body.layout-admin.menu-open #menu_admin #logo p{
        display: block !important;
      }
      
      body.layout-admin.menu-open #frame_menu > #main_menu a{
        justify-content: flex-start !important;
        padding-left: 1rem !important;
      }
      
      body.layout-admin.menu-open #logout a{
        justify-content: flex-start !important;
        padding-left: 1rem !important;
      }
      
      body.layout-admin.menu-open #frame_menu > #main_menu a i{
      ...
      @media (max-width: 768px){
        ...
        body.layout-admin.menu-open > #menu_admin{
            ...
            width: 15rem !important; /* Giữ nguyên chiều rộng khi mở */
        }
      }
    `;
